...
kc = LineClient("abi.singh1669@gmail.com","abi.singh66")
...
kd = LineClient("abi.singh1665@gmail.com","abi.singh66")
kd.log("Auth Token : " + str(kd.authToken))
channel5 = LineChannel(kd)
kd.log("Channel Access Token : " + str(channel5.channelAccessToken))


sw = LineClient("abi.singh1666@gmail.com","abi.singh66")
