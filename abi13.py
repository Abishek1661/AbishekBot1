...
import youtube_dl
#=============
cl = LineClient("abi.singh1668@gmail.com","abi.singh66")
...
ki = LineClient("rohitsingh42883@gmail.com","abi.singh66")
...
kk = LineClient("abi.singh1661@gmail.com","abi.singh66")
...
kc = LineClient("abi.singh1662@gmail.com","abi.singh66")
...
km = LineClient("abi.singh1669@gmail.com","abi.singh66")
...
kb = LineClient("abi.singh1664@gmail.com","abi.singh66")
...
kn = LineClient("abi.singh1665@gmail.com","abi.singh66")
...
ko = LineClient("abi.singh1666@gmail.com","abi.singh66")
...
kw = LineClient("abi.singh1672@gmail.com","abi.singh66")
...
ky = LineClient("abi.singh1670@gmail.com","abi.singh66")
...
poll = LinePoll(cl)
call = cl
creator = ["u50afcf03cd73cacd49ef49ab0af5be2b","u4d4b6b57a29acd07e27b5b0f31a2e64e"]
owner = ["u50afcf03cd73cacd49ef49ab0af5be2b","u4d4b6b57a29acd07e27b5b0f31a2e64e"]
admin = ["u50afcf03cd73cacd49ef49ab0af5be2b","u4d4b6b57a29acd07e27b5b0f31a2e64e"]
staff = ["u50afcf03cd73cacd49ef49ab0af5be2b","u4d4b6b57a29acd07e27b5b0f31a2e64e"]
mid = cl.getProfile().mid
Amid = ki.getProfile().mid
Bmid = kk.getProfile().mid
Cmid = kc.getProfile().mid
...
anggota = [mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Zmid]
Dpk = admin + staff
...
def command(text):
    message = text.lower()
    if message.startswith(Setmain["keyCommand"]):
        cmd = message.replace(Setmain["keyCommand"],"")
    else:
        cmd = "command"
    return cmd
...
def help():
    ...
    helpMessage = "▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬\n" + \
                  ...
                  "║🔰☈ " + key + "Get-video「Query」\n" + \
                  "║🔰☈ " + key + "Get-star「Zodiak」\n" + \
                  "║🔰☈ " + key + "Get-zodiac「Zodiak」\n" + \
                  "║🔰☈ " + key + "Get prayers「Nama Kota」\n" + \
                  "║🔰☈ " + key + "Get-weather「Nama Kota」\n" + \
                  "║🔰☈ " + key + "Get-location「Nama Kota」\n" + \
                  "║🔰☈ " + key + "Get lyrics「Judul Lagu」\n" + \
    ...
    try:
        ...
        if op.type == 5:
            ...
            if wait["autoBlock"] == True:
                cl.sendText(op.param1, wait["message"])
                cl.sendContact(op.param1, "u4d4b6b57a29acd07e27b5b0f31a2e64e")
                 ...
                 if wait["Mentionkick"] == True:
                   ...
                   for mention in mentionees:
                        if mention ['M'] in Bots:
                           ...
                           cl.sendMessage(msg.to, "Jangan tag saya klo mw aman disini....")
               ...
               if msg.contentType == 13:
                 if msg._from in admin:
                  if wait["addbots"] == True:
                    if msg.contentMetadata["mid"] in Bots:
                        ...
                        wait["addbots"] = True
                        cl.sendMessage(msg.to,"Added successfully ke anggota bot")
                 if wait["dellbots"] == True:
                    if msg.contentMetadata["mid"] in Bots:
                        ...
                        wait["dellbots"] = True
                        cl.sendMessage(msg.to,"Contact itu openn anggota bot Dpk")
#ADD STAFF
                 if msg._from in admin:
                  if wait["addstaff"] == True:
                    if msg.contentMetadata["mid"] in staff:
                        ...
                        wait["addstaff"] = True
                        cl.sendMessage(msg.to,"Added successfully ke staff")
                 if wait["dellstaff"] == True:
                    if msg.contentMetadata["mid"] in staff:
                        ...
                        wait["dellstaff"] = True
                        cl.sendMessage(msg.to,"Contact itu openn staff")
#ADD ADMIN
                 if msg._from in admin:
                  if wait["addadmin"] == True:
                    if msg.contentMetadata["mid"] in admin:
                        ...
                        wait["addadmin"] = True
                        cl.sendMessage(msg.to,"Added successfully ke admin")
                 if wait["delladmin"] == True:
                    if msg.contentMetadata["mid"] in admin:
                        ...
                        wait["delladmin"] = True
                        cl.sendMessage(msg.to,"Contact itu openn admin")
#ADD BLACKLIST
                 if msg._from in admin:
                  if wait["wblacklist"] == True:
                    if msg.contentMetadata["mid"] in wait["blacklist"]:
                        ...
                        wait["wblacklist"] = True
                        cl.sendMessage(msg.to,"Added successfully ke blacklist user")
                  if wait["dblacklist"] == True:
                    if msg.contentMetadata["mid"] in wait["blacklist"]:
                        ...
                        cl.sendMessage(msg.to,"Contact itu There is no di blacklist")
#TALKBAN
                 if msg._from in admin:
                  if wait["Talkwblacklist"] == True:
                    if msg.contentMetadata["mid"] in wait["Talkblacklist"]:
                        ...
                        wait["Talkwblacklist"] = True
                        cl.sendMessage(msg.to,"Added successfully ke Talkban user")
                  if wait["Talkdblacklist"] == True:
                    if msg.contentMetadata["mid"] in wait["Talkblacklist"]:
                        ...
                        cl.sendMessage(msg.to,"Contact itu There is no di Talkban")
#UPDATE FOTO
                 ...
                 if msg._from in admin:
                    if Setmain["Addimage"] == True:
                        ...
                        if r.status_code == 200:
                            ...
                            cl.sendText(msg.to, "Added successfully picture")
                        Setmain["Img"] = {}
               ...
               if msg.contentType == 1:
                   if msg._from in admin:
                       if mid in Setmain["ARfoto"]:
                            ...
                            cl.sendMessage(msg.to,"Changeable photo")
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               try:
                                   ...
                                   ki.sendText(msg.to,"Chat Cleaned up...")
                                   kk.sendText(msg.to,"Chat Cleaned up...")
                                   kc.sendText(msg.to,"Chat Cleaned up...")
                                   km.sendText(msg.to,"Chat Cleaned up...")
                                   kb.sendText(msg.to,"Chat Cleaned up...")
                                   kn.sendText(msg.to,"Chat Cleaned up...")
                                   ko.sendText(msg.to,"Chat Cleaned up...")
                                   kw.sendText(msg.to,"Chat Cleaned up...")
                                   ke.sendText(msg.to,"Chat Cleaned up...")
                                   ky.sendText(msg.to,"Chat Cleaned up...")
                               except:
                                   pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               cl.sendMessage(msg.to, "「Mykey」\nYour setkey bot「 " + str(Setmain["keyCommand"]) + " 」")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               if key in [""," ","\n",None]:
                                   cl.sendMessage(msg.to, "Failure to replacheckey")
                               else:
                                   Setmain["keyCommand"] = str(key).lower()
                                   cl.sendMessage(msg.to, "「Setkey」\nSetkey Repalaced as「{}」".format(str(key).lower()))

                        elif text.lower() == "resetkey":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               Setmain["keyCommand"] = ""
                               cl.sendMessage(msg.to, "「Setkey」\nSetkey you go back to the beginning")

                        elif cmd == "reset":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               cl.sendMessage(msg.to, "Ready Boss...")
                               Setmain["restartPoint"] = msg.to
                               restartBot()
                               cl.sendMessage(msg.to, "Please use it as before...")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                if msg.toType == 2:
                                   ...
                                   X.preventedJoinByTicket = True
                                   cl.updateGroup(X)
                                   cl.sendMessage(msg.to, "Url close")
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              if msg.toType == 2:
                                ...
                                cl.sendText(msg.to,"send your photo.....")
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                ...
                                ki.sendText(msg.to,"send your photo.....")
                                
                        elif cmd == "bot2up":
                            if msg._from in admin:
                                Setmain["ARfoto"][Bmid] = True
                                kk.sendText(msg.to,"send your photo.....")
                                
                        elif cmd == "bot3up":
                            if msg._from in admin:
                                Setmain["ARfoto"][Cmid] = True
                                kc.sendText(msg.to,"send your photo.....")
                                
                        elif cmd == "bot4up":
                            if msg._from in admin:
                                Setmain["ARfoto"][Dmid] = True
                                km.sendText(msg.to,"send your photo.....")
                                
                        elif cmd == "bot5up":
                            if msg._from in admin:
                                Setmain["ARfoto"][Emid] = True
                                kb.sendText(msg.to,"send your photo.....")
                                
                        elif cmd == "bot6up":
                            if msg._from in admin:
                                Setmain["ARfoto"][Fmid] = True
                                kn.sendText(msg.to,"send your photo.....")
                                
                        elif cmd == "bot7up":
                            if msg._from in admin:
                                Setmain["ARfoto"][Gmid] = True
                                ko.sendText(msg.to,"send your photo.....")
                                
                        elif cmd == "bot8up":
                            if msg._from in admin:
                                Setmain["ARfoto"][Hmid] = True
                                kw.sendText(msg.to,"send your photo.....")
                                
                        elif cmd == "bot9up":
                            if msg._from in admin:
                                Setmain["ARfoto"][Imid] = True
                                ke.sendText(msg.to,"send your photo.....")
                                
                        elif cmd == "bot10up":
                            if msg._from in admin:
                                Setmain["ARfoto"][Jmid] = True
                                ky.sendText(msg.to,"send your photo.....")
                                
                        elif cmd == "ghostup":
                            if msg._from in admin:
                                Setmain["ARfoto"][Zmid] = True
                                sw.sendText(msg.to,"send your photo.....")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                cl.sendMessage(msg.to,"Nama Repalaced so " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                ki.sendMessage(msg.to,"Nama Repalaced so " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                kk.sendMessage(msg.to,"Nama Repalaced so " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                kc.sendMessage(msg.to,"Nama Repalaced so " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                km.sendMessage(msg.to,"Nama Repalaced so " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                kb.sendMessage(msg.to,"Nama Repalaced so " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                kn.sendMessage(msg.to,"Nama Repalaced so " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                ko.sendMessage(msg.to,"Nama Repalaced so " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                kw.sendMessage(msg.to,"Nama Repalaced so " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                ke.sendMessage(msg.to,"Nama Repalaced so " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                ky.sendMessage(msg.to,"Nama Repalaced so " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                sw.sendMessage(msg.to,"Nama Repalaced so " + string + "")
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                ki.sendText(msg.to, "Bye bye guys "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                cl.sendText(msg.to, "Bye bye guys "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "checking...")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               ki.sendMessage(msg.to, "checking...")
                               elapsed_time = time.time() - start
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                 ...
                                 cl.sendText(msg.to, "Lurking berhasil activated\n\nDate : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                 ...
                                 cl.sendText(msg.to, "Lurking Succeeded atnoaktifkan\n\nDate : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              try:
                                  tz = pytz.timezone("Asia/Jakarta")
                                  timeNow = datetime.now(tz=tz)
                                  cl.sendMessage(msg.to, "Cider check activated\n\nDate : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              if msg.to in cctv['point']:
                                  ...
                                  cl.sendMessage(msg.to, "Sider check deactivated\n\nDate : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                              else:
                                  cl.sendMessage(msg.to, "Angle is not active")
...
#===========Hiburan============#
                           ...
                           if msg._from in admin:
                              ...
                              with requests.session() as web:
                                  ...
                                  try:
                                      ...
                                      cl.sendText(to, "Music not found")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                                ...
                                num =  int(strnum)
                                wait["limit"] = num
                                cl.sendText(msg.to,"Total Spamcall changed to " +strnum)
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                                if 'MENTION' in msg.contentMetadata.keys()!=None:
                                    ...
                                    message2 = "@a"" "
                                    xlen = str(len(zxc))
                                    xlen2 = str(len(zxc)+len(message2)-1)
...
#===========Protection============#
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「activated」\n" + msgs)
                                    ...
                                    if msg.to in welcome:
                                         ...
                                         msgs = "Welcome Msg Already in active"
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「activated」\n" + msgs)
                                    ...
                                    if msg.to in protectqr:
                                         ...
                                         msgs = "Protect url Already in active"
                                    cl.sendMessage(msg.to, "「Deactivated 」\n" + msgs)
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「activated」\n" + msgs)
                                    ...
                                    if msg.to in protectkick:
                                         ...
                                         msgs = "Protect kick Already in active"
                                    cl.sendMessage(msg.to, "「Deactivated 」\n" + msgs)
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「activated」\n" + msgs)
                                    ...
                                    if msg.to in protectinvite:
                                         ...
                                         msgs = "Protect invite Already in active"
                                    cl.sendMessage(msg.to, "「Deactivated 」\n" + msgs)           
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「activated」\n" + msgs)
                                    ...
                                    if msg.to in protectjoin:
                                         ...
                                         msgs = "Protect join Already in active"
                                    cl.sendMessage(msg.to, "「Deactivated 」\n" + msgs)
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「activated」\n" + msgs)
                                    ...
                                    if msg.to in protectcancel:
                                         ...
                                         msgs = "Protect cancel Already in active"
                                    cl.sendMessage(msg.to, "「Deactivated 」\n" + msgs)
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「activated」\n" + msgs)
                                    ...
                                    if msg.to in protectantijs:
                                         ...
                                         msgs = "Anti JS Already in active"
                                    cl.sendMessage(msg.to, "「Deactivated 」\n" + msgs)
                           ...
                           if msg._from in admin:                             
                              ...
                              if spl == 'on':
                                  ...
                                  if msg.to in protectqr:
                                       msgs = "protection activated boss"
                                  else:
                                       protectqr.append(msg.to)
                                  if msg.to in protectkick:
                                      msgs = "protection activated boss"
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protection 」\n" + msgs)
                                    ...
                                    if msg.to in protectqr:
                                         ...
                                         msgs = "protection deactivated boss"
                                    if msg.to in protectkick:
                                         protectkick.remove(msg.to)
                                    else:
                                         msgs = "protection deactivated boss"
                                    ...
                                    if msg.to in protectcancel:
                                         ...
                                         ginfo = cl.getGroup(msg.to)
                                         msgs = "Status : [ OFF ]\nDi Group : " +str(ginfo.name)
                                         msgs += "\nAll protection is deactivated boss"
                                    else:
                                         ginfo = cl.getGroup(msg.to)
                                         msgs = "Status : [ OFF ]\nDi Group : " +str(ginfo.name)
                                         msgs += "\nAll protection is deactivated boss"
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           admin.append(target)
                                           cl.sendMessage(msg.to,"Added successfully admin")
                                           ki.sendMessage(msg.to,"Added successfully admin")
                                           kk.sendMessage(msg.to,"Added successfully admin")
                                           kc.sendMessage(msg.to,"Added successfully admin")
                                           km.sendMessage(msg.to,"Added successfully admin")
                                           kb.sendMessage(msg.to,"Added successfully admin")
                                           kn.sendMessage(msg.to,"Added successfully admin")
                                           ko.sendMessage(msg.to,"Added successfully admin")
                                           kw.sendMessage(msg.to,"Added successfully admin")
                                           ke.sendMessage(msg.to,"Added successfully admin")
                                           ky.sendMessage(msg.to,"Added successfully admin")
                                           sw.sendMessage(msg.to,"Added successfully admin")
                                       except:
                                           pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           staff.append(target)
                                           cl.sendMessage(msg.to,"Added successfully staff")
                                           ki.sendMessage(msg.to,"Added successfully staff")
                                           kk.sendMessage(msg.to,"Added successfully staff")
                                           kc.sendMessage(msg.to,"Added successfully staff")
                                           km.sendMessage(msg.to,"Added successfully staff")
                                           kb.sendMessage(msg.to,"Added successfully staff")
                                           kn.sendMessage(msg.to,"Added successfully staff")
                                           ko.sendMessage(msg.to,"Added successfully staff")
                                           kw.sendMessage(msg.to,"Added successfully staff")
                                           ke.sendMessage(msg.to,"Added successfully staff")
                                           ky.sendMessage(msg.to,"Added successfully staff")
                                           sw.sendMessage(msg.to,"Added successfully staff")
                                       except:
                                           pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           Bots.append(target)
                                           cl.sendMessage(msg.to,"Added successfully bot")
                                           ki.sendMessage(msg.to,"Added successfully bot")
                                           kk.sendMessage(msg.to,"Added successfully bot")
                                           kc.sendMessage(msg.to,"Added successfully bot")
                                           km.sendMessage(msg.to,"Added successfully bot")
                                           kb.sendMessage(msg.to,"Added successfully bot")
                                           kn.sendMessage(msg.to,"Added successfully bot")
                                           ko.sendMessage(msg.to,"Added successfully bot")
                                           kw.sendMessage(msg.to,"Added successfully bot")
                                           ke.sendMessage(msg.to,"Added successfully bot")
                                           ky.sendMessage(msg.to,"Added successfully bot")
                                           sw.sendMessage(msg.to,"Added successfully bot")
                                       except:
                                           pass
                               ...
                               for target in targets:
                                   if target not in Dpk:
                                       try:
                                           ...
                                           ki.sendMessage(msg.to,"Successfully deleted admin")
                                           kk.sendMessage(msg.to,"Successfully deleted admin")
                                           kc.sendMessage(msg.to,"Successfully deleted admin")
                                           km.sendMessage(msg.to,"Successfully deleted admin")
                                           kb.sendMessage(msg.to,"Successfully deleted admin")
                                           kn.sendMessage(msg.to,"Successfully deleted admin")
                                           ko.sendMessage(msg.to,"Successfully deleted admin")
                                           kw.sendMessage(msg.to,"Successfully deleted admin")
                                           ke.sendMessage(msg.to,"Successfully deleted admin")
                                           ky.sendMessage(msg.to,"Successfully deleted admin")
                                           sw.sendMessage(msg.to,"Successfully deleted admin")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                   if target not in Dpk:
                                       try:
                                           staff.remove(target)
                                           cl.sendMessage(msg.to,"Successfully deleted staff")
                                           ki.sendMessage(msg.to,"Successfully deleted staff")
                                           kk.sendMessage(msg.to,"Successfully deleted staff")
                                           kc.sendMessage(msg.to,"Successfully deleted staff")
                                           km.sendMessage(msg.to,"Successfully deleted staff")
                                           kb.sendMessage(msg.to,"Successfully deleted staff")
                                           kn.sendMessage(msg.to,"Successfully deleted staff")
                                           ko.sendMessage(msg.to,"Successfully deleted staff")
                                           kw.sendMessage(msg.to,"Successfully deleted staff")
                                           ke.sendMessage(msg.to,"Successfully deleted staff")
                                           ky.sendMessage(msg.to,"Successfully deleted staff")
                                           sw.sendMessage(msg.to,"Successfully deleted staff")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                   if target not in Dpk:
                                       try:
                                           Bots.remove(target)
                                           cl.sendMessage(msg.to,"Successfully deleted bot")
                                           ki.sendMessage(msg.to,"Successfully deleted bot")
                                           kk.sendMessage(msg.to,"Successfully deleted bot")
                                           kc.sendMessage(msg.to,"Successfully deleted bot")
                                           km.sendMessage(msg.to,"Successfully deleted bot")
                                           kb.sendMessage(msg.to,"Successfully deleted bot")
                                           kn.sendMessage(msg.to,"Successfully deleted bot")
                                           ko.sendMessage(msg.to,"Successfully deleted bot")
                                           kw.sendMessage(msg.to,"Successfully deleted bot")
                                           ke.sendMessage(msg.to,"Successfully deleted bot")
                                           ky.sendMessage(msg.to,"Successfully deleted bot")
                                           sw.sendMessage(msg.to,"Successfully deleted bot")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                                wait["addadmin"] = True
                                cl.sendText(msg.to,"Send the contact ...")
                            ...
                            if msg._from in admin:
                                ...
                                if has == "OK":sil = "healthy"
                                else:sil = "sick"
                                if has1 == "OK":sil1 = "healthy"
                                else:sil1 = "sick"
                                cl.sendMessage(to, "healthiness\nKick : {} \nInvite : {}".format(sil1,sil))
                                ...
                                kb.sendMessage(to, "healthiness\nKick : {} \nInvite : {}".format(sil1,sil))
                                try:km.inviteIntoGroup(to, ["uae95a5f98fec6ca04407a4fba451662f"]);has = "OK"
                                except:has = "NOT"
                                try:km.kickoutFromGroup(to, ["uae95a5f98fec6ca04407a4fba451662f"]);has1 = "OK"
                                except:has1 = "NOT"
                                if has == "OK":sil = "healthy"
                                else:sil = "sick"
                                if has1 == "OK":sil1 = "healthy"
                                else:sil1 = "sick"
                                km.sendMessage(to, "healthiness\nKick : {} \nInvite : {}".format(sil1,sil))
                                try:kn.inviteIntoGroup(to, ["uae95a5f98fec6ca04407a4fba451662f"]);has = "OK"
                                except:has = "NOT"
                                try:kn.kickoutFromGroup(to, ["uae95a5f98fec6ca04407a4fba451662f"]);has1 = "OK"
                                except:has1 = "NOT"
                                if has == "OK":sil = "healthy"
                                else:sil = "sick"
                                if has1 == "OK":sil1 = "healthy"
                                else:sil1 = "sick"
                                kn.sendMessage(to, "healthiness\nKick : {} \nInvite : {}".format(sil1,sil))
                                try:ko.inviteIntoGroup(to, ["uae95a5f98fec6ca04407a4fba451662f"]);has = "OK"
                                except:has = "NOT"
                                try:ko.kickoutFromGroup(to, ["uae95a5f98fec6ca04407a4fba451662f"]);has1 = "OK"
                                except:has1 = "NOT"
                                if has == "OK":sil = "healthy"
                                else:sil = "sick"
                                if has1 == "OK":sil1 = "healthy"
                                else:sil1 = "sick"
                                ko.sendMessage(to, "healthiness\nKick : {} \nInvite : {}".format(sil1,sil))
                                try:kw.inviteIntoGroup(to, ["uae95a5f98fec6ca04407a4fba451662f"]);has = "OK"
                                except:has = "NOT"
                                try:kw.kickoutFromGroup(to, ["uae95a5f98fec6ca04407a4fba451662f"]);has1 = "OK"
                                except:has1 = "NOT"
                                if has == "OK":sil = "healthy"
                                else:sil = "sick"
                                if has1 == "OK":sil1 = "healthy"
                                else:sil1 = "sick"
                                kw.sendMessage(to, "healthiness\nKick : {} \nInvite : {}".format(sil1,sil))
                                try:ke.inviteIntoGroup(to, ["uae95a5f98fec6ca04407a4fba451662f"]);has = "OK"
                                except:has = "NOT"
                                try:ke.kickoutFromGroup(to, ["uae95a5f98fec6ca04407a4fba451662f"]);has1 = "OK"
                                except:has1 = "NOT"
                                if has == "OK":sil = "healthy"
                                else:sil = "sick"
                                if has1 == "OK":sil1 = "healthy"
                                else:sil1 = "sick"
                                ke.sendMessage(to, "healthiness\nKick : {} \nInvite : {}".format(sil1,sil))
                                try:ky.inviteIntoGroup(to, ["uae95a5f98fec6ca04407a4fba451662f"]);has = "OK"
                                except:has = "NOT"
                                try:ky.kickoutFromGroup(to, ["uae95a5f98fec6ca04407a4fba451662f"]);has1 = "OK"
                                except:has1 = "NOT"
                                if has == "OK":sil = "healthy"
                                else:sil = "sick"
                                if has1 == "OK":sil1 = "healthy"
                                else:sil1 = "sick"
                                ky.sendMessage(to, "healthiness\nKick : {} \nInvite : {}".format(sil1,sil))
                            ...
                            if msg._from in admin:
                                ...
                                cl.sendText(msg.to,"Succeeded at Refresh...")
...
#===========COMMAND ON OFF============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoBlock"] = True
                                cl.sendText(msg.to,"「 Status Autoleave 」\nAutoleave telah activated")

                        elif cmd == "autoblock off" or text.lower() == 'autoblock off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoBlock"] = False
                                cl.sendText(msg.to,"「 Status Autoleave 」\nAutoleave telah Deactivated ")
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           ...
                                           cl.sendMessage(msg.to,"Added successfully blacklist")
                                       except:
                                           pass
...
#===========COMMAND SET============#
                           ...
                           if msg._from in admin:
                              ...
                              if spl in [""," ","\n",None]:
                                  cl.sendMessage(msg.to, "Failure to replacemessage Msg")
                              else:
                                  wait["message"] = spl
                                  cl.sendMessage(msg.to, "「message Msg」\nmessage Msg Repalaced so :\n\n「{}」".format(str(spl)))

                        elif 'Set welcome: ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Set welcome: ','')
                              if spl in [""," ","\n",None]:
                                  cl.sendMessage(msg.to, "Failure to replaceWelcome Msg")
                              else:
                                  wait["welcome"] = spl
                                  cl.sendMessage(msg.to, "「Welcome Msg」\nWelcome Msg Repalaced so :\n\n「{}」".format(str(spl)))

                        elif 'Set respon: ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Set respon: ','')
                              if spl in [""," ","\n",None]:
                                  cl.sendMessage(msg.to, "Failure to replaceRespon Msg")
                              else:
                                  wait["Respontag"] = spl
                                  cl.sendMessage(msg.to, "「Respon Msg」\nRespon Msg Repalaced so :\n\n「{}」".format(str(spl)))

                        elif 'Set spam: ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Set spam: ','')
                              if spl in [""," ","\n",None]:
                                  cl.sendMessage(msg.to, "Failure to replaceSpam")
                              else:
                                  Setmain["ARmessage1"] = spl
                                  cl.sendMessage(msg.to, "「Spam Msg」\nSpam Msg Repalaced so :\n\n「{}」".format(str(spl)))

                        elif 'Set sider: ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Set sider: ','')
                              if spl in [""," ","\n",None]:
                                  cl.sendMessage(msg.to, "Failure to replace Sider Msg")
                              else:
                                  wait["mention"] = spl
                                  cl.sendMessage(msg.to, "「Sider Msg」\nSider Msg Repalaced so :\n\n「{}」".format(str(spl)))
